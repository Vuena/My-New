...
document.addEventListener('DOMContentLoaded', () => {
  try {
    ...
    function checkAuth() {
        const user = localStorage.getItem('premiumPeekUser');
        if (user) {
    ...
    function toggleLogin() {
        if (loginModal.classList.contains('hidden')) {
            ...
            // Small delay for fade-in opacity
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', (e) => {
            ...
            setTimeout(() => {
                ...
                localStorage.setItem('premiumPeekUser', name);
                checkAuth();
                toggleLogin();
                // Reset form
                loginForm.reset();
    ...
    if (logoutBtn) {
        logoutBtn.addEventListener('click', () => {
            localStorage.removeItem('premiumPeekUser');
            checkAuth();
        });
    }
